...
If the user did NOT pass `--allow-rewrite-merged`, use the graphical or structured user-input capability:
...
- `--allow-rewrite-merged` skips the graphical or structured user-input capability prompt but does NOT skip the integrity or exact-revision publication gate.
