...
Client owns no standards and declares no standards-bearing plugin dependency. Follow the selected skill and `essential:references/state.md`; do not import standards from an undeclared plugin.
